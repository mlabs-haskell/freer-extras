...
tests = do
    testGroup
        ...
        [ testGroup
            "select page"
            [ testProperty
                "size of pageItems of all pages should be less or equal than total number of items in database"
            ...
            , testProperty
                "page size equal to total number of items in db should return a single page"
